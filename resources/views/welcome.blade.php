...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="css/sequence.css"/>
    <link rel="stylesheet" type="text/css" media="screen" href="css/sequence-parallax.css"/>
    ...
    <div class="navbar navbar-default navbar-static-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#home">Jiggaman Civils & Plant Hire</a> </div>
            ...
            <div class="col-sm-6">
                <div class="map-rap">
                    ...
                    <div class="map-address">
                        <ul>
                            <li><i class="fa fa-map-marker"></i> <span>3 Peace Rd, A1001 AUmlazi, 4031, South Africa</span> </li>
                            <li> <i class="fa fa-envelope"></i><span> mjez@webmail.co.za</span></li>
                            <li><i class="fa  fa-phone"></i> <span> (031) 906 1395 </span></li>
                            <li><i class="fa  fa-print"></i> <span> (031) 906 6635</span></li>
                            <li><i class="fa  fa-mobile-phone"></i> <span> 082 932 2526 </span></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="footer">
    <div class="container">
        ...
        <p>Copyright &copy; 2018 Designed and Developed By<a href=""> Blaque Dev Ops.</a></p>
        <ul>
            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
            {{--<li><a href="#"><i class="fa fa-google-plus"></i></a></li>--}}
